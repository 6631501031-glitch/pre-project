...
async function run() {
  ...
  const sessionToken = process.env.PROJECT_E2E_ADMIN_X_ACCESS_TOKEN || 'graduationsystemusingfacerecognition-e2e-admin-token';
  ...
  const account = await AccountModel.findOneAndUpdate(
    { email: email },
    {
      $set: {
        ...
        userinfo: {
          firstName: [{ key: 'en', value: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION' }],
        ...
        control: {
          ...
          device: [{
            ...
            deviceId: 'graduationsystemusingfacerecognition-seed-device',
            fingerprint: 'graduationsystemusingfacerecognition-seed-fingerprint',
            networkKey: '127.0.0',
