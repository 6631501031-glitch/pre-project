...
const { createGRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONIamService } = require('../server/integrations/graduationsystemusingfacerecognition/graduationsystemusingfacerecognition-iam.service');
...
function createIamService() {
  return createGRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONIamService({
...
function buildManagedClientConfig() {
  ...
  const projectCode = firstNonEmpty(project.code, 'graduationsystemusingfacerecognition');
  const projectName = firstNonEmpty(project.name, 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION');
  ...
  return {
    ...
    metadata: {
      ...
      environments: [{
        ...
        healthCheckUrl: managedClientConfig.projectBaseUrl.replace(/\/+$/, '') + '/api/v1/graduationsystemusingfacerecognition/documents/stats',
