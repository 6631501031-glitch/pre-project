...
function getFromAddress(options) {
    ...
    const name = cleanString(options && options.fromName) || cleanString(options && options.appName) || "GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION";
