...
const APP_ID = 'graduationsystemusingfacerecognition';
...
function baseContext(context) {
    ...
    return Object.assign({
        appName: getEnv('PROJECT_MAIL_APP_NAME', getEnv('APP_NAME', 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION')),
...
function senderFromConfig(config) {
    ...
    return {
        ...
        fromName: cleanString(config && config.fromName) || cleanString(config && config.appName) || 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION',
        appName: cleanString(config && config.appName) || 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION'
    };
}
