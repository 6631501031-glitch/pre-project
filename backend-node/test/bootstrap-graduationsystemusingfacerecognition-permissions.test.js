...
test('GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION bootstrap script provisions permissions and assigns the configured IAM account', async function () {
  const scriptPath = path.resolve(__dirname, '../scripts/bootstrap-graduationsystemusingfacerecognition-permissions.js');
  const execution = await execFileAsync(process.execPath, [scriptPath], {
    ...
    env: Object.assign({}, process.env, {
      ...
      PROJECT_PERMISSION_TYPE_TITLE: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Administration',
      PROJECT_PERMISSION_GROUP_TITLE: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Admin',
      PROJECT_PERMISSION_ROOT_PATH: '/graduation-system-using-face-recognition/security/permission',
      PROJECT_PERMISSION_PATHS: '/graduation-system-using-face-recognition/security/permission,/dashboard,/accounts/directory',
  ...
  assert.ok(payload.paths.includes('/graduation-system-using-face-recognition/security/permission'));
