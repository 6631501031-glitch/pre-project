...
function createMockIamServer() {
  const state = {
    ...
    serviceClients: [
      {
        ...
        allowedAudiences: ['graduationsystemusingfacerecognition-api'],
        metadata: {
          targetSystem: 'graduationsystemusingfacerecognition',
      ...
      },
      {
        ...
        clientSecret: 'super-secret',
        clientName: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION IAM SDK',
        partnerId: 'graduation-system-using-face-recognition-team',
        tenant: 'iam-shared',
        allowedScopes: 'graduation.system.using.face.recognition.registry.read graduation.system.using.face.recognition.registry.write graduation.system.using.face.recognition.report.read iam.security.read iam.security.write iam.audit.read iam.accounts.read',
        allowedAudiences: ['graduationsystemusingfacerecognition-api'],
        metadata: {
          targetSystem: 'graduationsystemusingfacerecognition',
          ownerEmail: 'graduation-system-using-face-recognition.integration@example.com'
        }
      }
    ],
    apps: [
    ...
    types: [
      ...
      {
        _id: 'type-graduationsystemusingfacerecognition',
        title: [{ key: 'en', value: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Administration' }],
        description: [{ key: 'en', value: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION controls' }],
        state: true
      }
    ],
    menus: [
      ...
      },
      {
        ...
        description: [{ key: 'en', value: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION account directory' }],
      ...
      },
      {
        ...
        description: [{ key: 'en', value: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION account lifecycle' }],
    ...
    accounts: [
      {
        ...
        status: { key: 'ACTIVE' },
        securityGroups: [{ _id: 'group-2', title: [{ key: 'en', value: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Admin' }] }],
  ...
  function buildToken(client, scope, audience) {
    ...
    ) || 'graduationsystemusingfacerecognition-api';
    const payload = {
      active: true,
      access_token: token,
      token_type: 'Bearer',
      ...
      partner_id: client.partnerId || 'graduation-system-using-face-recognition-team',
  ...
  async function handler(request, response) {
    ...
    if (request.method === 'GET' && pathname === '/api/v1/b2b/clients/me') {
      ...
      writeJson(response, 200, {
        ...
        metadata: {
          targetSystem: payload.client_id === 'sample-sdk' ? 'graduationsystemusingfacerecognition' : 'graduationsystemusingfacerecognition'
        }
      });
      return;
    }
