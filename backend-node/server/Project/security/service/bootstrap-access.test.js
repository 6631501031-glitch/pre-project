...
test('bootstrap-access is a no-op when GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION runs with IAM-backed permissions', async function () {
  let touched = false;
