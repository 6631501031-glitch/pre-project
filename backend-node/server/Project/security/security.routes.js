...
const APP_SCOPE = 'graduationsystemusingfacerecognition';
...
function withGRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONScope(body) {
...
router.post('/type', canEditType, function (request, response) {
  return iamAdminClient.forwardAdminRequest(request, response, {
    method: 'post',
    path: '/security/type',
    data: withGRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONScope(request.body),
    successStatus: 201
  });
});
