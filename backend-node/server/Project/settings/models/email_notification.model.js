...
var objsSchema = new Schema({
    ...
    appName: { type: String, default: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION' },
    appUrl: { type: String, default: '' },
    from: { type: String, default: '' },
    fromName: { type: String, default: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION' },
    smtp: {
