...
const SEED_ACCESS_PROFILES = [
    ...
    { key: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION_OPERATIONS', defaultScope: 'division', title: { th: 'ปฏิบัติการการเงิน', en: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Operations' } },
...
const SEED_POSITION_RULES = [
    ...
    { key: 'RULE_GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION', title: { th: 'สิทธิ์การเงิน', en: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Rule' }, matchType: 'CONTAINS', matchValues: ['graduationsystemusingfacerecognition', 'การเงิน'], orgScope: 'division', priority: 40, affiliationKeys: ['OPERATIONAL'], profileKeys: ['GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION_OPERATIONS'] },
