...
test('pay hub email delivery service scopes get requests to graduationsystemusingfacerecognition', async function () {
    let requestOptions = null;
    iamAdminClient.requestAdmin = async function (options) {
        requestOptions = options;
        return { number: 0, code: 20000, data: { appId: 'graduationsystemusingfacerecognition' } };
    };
...
test('pay hub email delivery service scopes update payloads to graduationsystemusingfacerecognition', async function () {
    let requestOptions = null;
    iamAdminClient.requestAdmin = async function (options) {
        requestOptions = options;
    ...
    await emailDeliveryService.onUpdate({
        body: {
            ...
            smtp: {
                host: 'smtp.graduationsystemusingfacerecognition.example.test'
            }
        },
        headers: {
            lang: 'th'
    ...
    assert.equal(requestOptions.data.appId, 'graduationsystemusingfacerecognition');
    assert.equal(requestOptions.data.appName, 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION');
});
