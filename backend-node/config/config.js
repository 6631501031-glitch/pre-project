...
var projectCode = firstNonEmpty(process.env.PROJECT_CODE, 'graduationsystemusingfacerecognition');
var projectName = firstNonEmpty(process.env.PROJECT_NAME, 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION');
...
var projectBaseUrl = firstNonEmpty(process.env.PROJECT_BASE_URL, process.env.BASE_SERVER_URL, 'https://graduation-system-using-face-recognition.mfu.ac.th');
var projectSlug = slugify(projectCode || projectName || 'graduationsystemusingfacerecognition') || 'graduationsystemusingfacerecognition';
...
function buildDefaultPermissionPaths(rootPath) {
    return uniqueList([
        ...
        '/graduation-system-using-face-recognition/review',
        '/graduation-system-using-face-recognition/reports',
        '/operations/business',
        '/management/category',
...
var graduationsystemusingfacerecognitionPermissionRootPath = firstNonEmpty(
    process.env.PROJECT_PERMISSION_ROOT_PATH,
    process.env.PERMISSION_ROOT_PATH,
    '/' + projectSlug + '/security/permission'
);
var graduationsystemusingfacerecognitionPermissionPaths = uniqueList(
    buildDefaultPermissionPaths(graduationsystemusingfacerecognitionPermissionRootPath).concat(
        parseList(
            firstNonEmpty(
...
var graduationsystemusingfacerecognitionPermissionTypeTitle = firstNonEmpty(
    process.env.PROJECT_PERMISSION_TYPE_TITLE,
    process.env.PERMISSION_TYPE_TITLE,
    projectName + ' Administration'
);
var graduationsystemusingfacerecognitionPermissionGroupTitle = firstNonEmpty(
    process.env.PROJECT_PERMISSION_GROUP_TITLE,
    process.env.PERMISSION_GROUP_TITLE,
    projectName + ' Admin'
);
var graduationsystemusingfacerecognitionPermissionSource = firstNonEmpty(
    process.env.PROJECT_PERMISSION_SOURCE,
    process.env.PERMISSION_SOURCE,
    'iam'
).toLowerCase();
var graduationsystemusingfacerecognitionPermissionBootstrapMode = firstNonEmpty(
    process.env.PROJECT_PERMISSION_BOOTSTRAP_MODE,
    process.env.PERMISSION_BOOTSTRAP_MODE,
    'iam'
).toLowerCase();
var graduationsystemusingfacerecognitionAuthRequire2FA = toBoolean(
    firstNonEmpty(
...
var graduationsystemusingfacerecognitionAuditRetentionDays = toNumber(
    firstNonEmpty(
...
module.exports = {
    ...
    security: {
        auditRetentionDays: graduationsystemusingfacerecognitionAuditRetentionDays,
        authRequire2FA: graduationsystemusingfacerecognitionAuthRequire2FA,
        permissionGroupTitle: graduationsystemusingfacerecognitionPermissionGroupTitle,
        permissionRootPath: graduationsystemusingfacerecognitionPermissionRootPath,
        permissionPaths: graduationsystemusingfacerecognitionPermissionPaths,
        permissionSource: graduationsystemusingfacerecognitionPermissionSource,
        permissionBootstrapMode: graduationsystemusingfacerecognitionPermissionBootstrapMode,
        permissionTypeTitle: graduationsystemusingfacerecognitionPermissionTypeTitle
    }
