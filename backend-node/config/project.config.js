...
const projectCode = firstNonEmpty(process.env.PROJECT_CODE, 'graduationsystemusingfacerecognition');
const projectName = firstNonEmpty(process.env.PROJECT_NAME, 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION');
const projectDescription = firstNonEmpty(process.env.PROJECT_DESCRIPTION, 'GRADUATION SYSTEM USING FACE RECOGNITION student project generated from Application Infomation sheet.');
...
const projectBaseUrl = firstNonEmpty(process.env.PROJECT_BASE_URL, 'https://graduation-system-using-face-recognition.mfu.ac.th');
