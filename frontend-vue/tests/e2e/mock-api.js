...
const securityTypes = [
  {
    _id: 'type-1',
    title: [{ key: 'en', value: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Administration' }],
    description: [{ key: 'en', value: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION security type' }],
    state: true
  }
];
...
const securityMenus = [
  {
    ...
    path: '/dashboard',
    type: { _id: 'type-1', title: [{ key: 'en', value: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Administration' }] },
    source: 'managed',
    state: true
  },
  {
...
const securityGroups = [
  {
    _id: 'group-1',
    title: [{ key: 'en', value: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Admin' }],
    description: [{ key: 'en', value: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION admin group' }],
    visibleType: { _id: 'type-1', title: [{ key: 'en', value: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Administration' }] },
    state: true
  }
];
...
const securityPermissions = [
  {
    _id: 'perm-1',
    group: { _id: 'group-1', title: [{ key: 'en', value: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Admin' }] },
    menu: { _id: 'menu-1', title: [{ key: 'en', value: 'Dashboard' }], path: '/dashboard', type: { _id: 'type-1', title: [{ key: 'en', value: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Administration' }] } },
    all: true,
    view: true,
    edit: true,
    delete: true,
...
const accountGroups = [
  { _id: 'graduationsystemusingfacerecognition-group-admin', label: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Admin' },
  { _id: 'graduationsystemusingfacerecognition-group-ops', label: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Operations' }
];

const accounts = [
  {
    _id: 'graduationsystemusingfacerecognition-account-1',
    code: 'M-0001',
    email: 'owner.graduationsystemusingfacerecognition@example.com',
    status: { key: 'ACTIVE', title: [{ key: 'en', value: 'Active' }] },
    securityGroups: [{ _id: 'graduationsystemusingfacerecognition-group-admin', title: [{ key: 'en', value: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Admin' }] }],
    userinfo: {
...
let emailNotificationSettings = {
  enabled: true,
  appName: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION',
  appUrl: 'https://graduationsystemusingfacerecognition.example.com',
  from: 'no-reply@graduationsystemusingfacerecognition.example.com',
  fromName: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION',
  replyTo: 'support@graduationsystemusingfacerecognition.example.com',
  smtp: {
    host: 'smtp.graduationsystemusingfacerecognition.example.com',
    port: 587,
    secure: false,
    user: 'mailer@graduationsystemusingfacerecognition.example.com',
    hasPass: true
  },
  activeTemplates: ['invite', 'twoFa'],
  invite: {
    subject: 'You are invited to GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION',
    text: 'Welcome to GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION',
    html: '<p>Welcome to GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION</p>'
  },
  twoFa: {
    subject: 'Your GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION verification code',
    text: '123456',
    html: '<p>123456</p>'
  }
};
...
let emailDeliverySettings = {
  key: 'delivery:graduationsystemusingfacerecognition',
  appId: 'graduationsystemusingfacerecognition',
  enabled: true,
  appName: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION',
  appUrl: 'https://graduationsystemusingfacerecognition.example.com',
  from: 'no-reply@graduationsystemusingfacerecognition.example.com',
...
const graduationsystemusingfacerecognitionEmailWorkflowDefinitions = [
  {
    eventKey: 'payment.created',
    legacyType: '',
    title: 'Payment created',
    description: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION notification when a payment request is created.',
  ...
  },
  {
    ...
    legacyType: '',
    title: 'Payment paid',
    description: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION notification when a payment is successfully paid.',
  ...
  },
  {
    ...
    description: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION notification when a payment attempt fails.',
  ...
  },
  {
    ...
    description: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION notification when a payment refund is completed.',
  ...
  },
  {
    ...
    description: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION notification when a merchant is approved.',
  ...
  },
  {
    ...
    description: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION notification when a merchant request is rejected.',
  ...
  },
  {
    ...
    description: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION notification when a settlement is completed.',
...
const graduationsystemusingfacerecognitionSharedWorkflowEventKeys = [
  'account.invite',
  'auth.2fa.request',
...
function emailWorkflowDefinitionsForApp(appId) {
  ...
  const definitions = normalizedAppId === 'graduationsystemusingfacerecognition'
    ? emailWorkflowDefinitions
      .filter(item => graduationsystemusingfacerecognitionSharedWorkflowEventKeys.indexOf(item.eventKey) !== -1)
      .concat(graduationsystemusingfacerecognitionEmailWorkflowDefinitions)
...
let databaseBackupSettings = {
  ...
  intervalHours: 24,
  retentionCount: 10,
  backupDir: '/var/backups/graduationsystemusingfacerecognition',
...
let databaseBackupRuns = [
  {
    ...
    mode: 'auto',
    status: 'completed',
    databaseName: 'graduationsystemusingfacerecognition-e2e',
    filename: 'graduation-system-using-face-recognition-graduationsystemusingfacerecognition-e2e-sample.json.gz',
    sizeBytes: 18432,
...
function buildBackupFilePreview(run) {
  ...
  return {
    run: clone(sourceRun),
    metadata: {
      app: 'graduationsystemusingfacerecognition',
      databaseName: sourceRun.databaseName || 'graduationsystemusingfacerecognition-e2e',
...
function requireGRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONAuth(req, res) {
  const token = getSessionToken(req);
  if (!token || token !== 'graduationsystemusingfacerecognition-e2e-token') {
...
function withAudit(payload) {
  return Object.assign({}, payload, {
    ...
    createdByName: 'graduationsystemusingfacerecognition.owner@example.com',
    updatedByName: 'graduationsystemusingfacerecognition.owner@example.com'
  });
}
...
const server = http.createServer((req, res) => {
  ...
  if (req.method === 'GET' && path === '/api/v1/auth/me') {
    if (!requireGRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONAuth(req, res)) return;
    writeJson(res, 200, {
      data: {
        _id: 'acc-1',
        email: 'graduationsystemusingfacerecognition.owner@example.com',
        role: 'owner'
      }
    });
    return;
  ...
  if (path.indexOf('/api/v1/accounts') === 0) {
    ...
    if (req.method === 'POST' && path === '/api/v1/accounts/invite') {
      readBody(req).then((body) => {
        const item = {
          _id: `graduationsystemusingfacerecognition-account-${Date.now()}`,
    ...
    if (req.method === 'POST' && path === '/api/v1/security/type') {
      readBody(req).then((body) => {
        const item = withAudit(Object.assign({
          _id: `type-${Date.now()}`,
          appId: 'graduationsystemusingfacerecognition',
          source: 'graduationsystemusingfacerecognition',
          description: [],
          state: true
        }, body || {}));
  ...
  if (path.indexOf('/api/v1/setting/') === 0) {
    ...
    if (req.method === 'POST' && path === '/api/v1/setting/database-backup/run') {
      ...
      const run = {
        ...
        status: 'completed',
        databaseName: 'graduationsystemusingfacerecognition-e2e',
        filename: `graduation-system-using-face-recognition-graduationsystemusingfacerecognition-e2e-${Date.now()}.json.gz`,
        sizeBytes: 20480,
...
server.listen(port, () => {
  process.stdout.write(`GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION mock API listening on http://127.0.0.1:${port}\n`);
});
