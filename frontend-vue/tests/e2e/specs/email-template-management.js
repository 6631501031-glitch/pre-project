...
module.exports = {
  'Email Template Management action button uses the expected GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION style': function (browser) {
    browser
    ...
    browser
      ...
      .executeAsync(function (done) {
        ...
        page.deliveryForm.replyTo = 'ops@graduationsystemusingfacerecognition.example.com'
        ...
        browser.assert.equal(result.value.replyTo, 'ops@graduationsystemusingfacerecognition.example.com')
  ...
  'Custom Email Template appears in Workflow Actions': function (browser) {
    ...
    browser
      ...
      .executeAsync(function (done) {
        ...
        modal.local.description = 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION notification when a payment expires.'
        ...
        page.saveTemplate({
          ...
          description: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION notification when a payment expires.',
