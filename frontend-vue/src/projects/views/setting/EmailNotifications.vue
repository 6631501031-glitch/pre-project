  ...
  <div class="security-page email-notification-page">
    ...
    <CCard class="bg-style2 email-config-card">
      <CCardBody>
        ...
        <CRow>
          <CCol md="6" col="12">
            <CInput v-model.trim="deliveryForm.appName" :label="$t('setting.emailNotifications.delivery.appName')" placeholder="GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION" />
          </CCol>
          <CCol md="6" col="12">
            <CInput v-model.trim="deliveryForm.appUrl" :label="$t('setting.emailNotifications.delivery.appUrl')" placeholder="https://graduation-system-using-face-recognition.mfu.ac.th" />
          </CCol>
          <CCol md="6" col="12">
            <CInput v-model.trim="deliveryForm.fromName" :label="$t('setting.emailNotifications.delivery.fromName')" placeholder="GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION" />
          </CCol>
          <CCol md="6" col="12">
...
const APP_CONTEXT = Object.freeze({
  ...
  appUrl: 'https://graduation-system-using-face-recognition.mfu.ac.th'
})
