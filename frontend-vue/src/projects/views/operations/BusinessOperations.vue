...
const PROFILE = {
  ...
  eyebrow: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Operations',
  title: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION Operating Desk',
  ...
  boardMeta: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION operation lanes',
  timelineMeta: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION office rhythm',
  metrics: [
    { label: 'Review queue', value: '18', hint: '5 legal checks pending', icon: 'cil-list-rich', accent: 'amber' },
    { label: 'Active GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONs', value: '126', hint: 'Across partner units', icon: 'cil-check-circle', accent: 'green' },
  ...
  board: [
    ...
    { lane: 'Approval Routing', detail: 'Executive approval and signatory tracking', owner: 'GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION Secretariat', throughput: '7 approvals', status: 'On Track' },
