  ...
  routes: [
    {
      ...
      children: [
        ...
        {
          path: 'graduation-system-using-face-recognition/registry',
          name: 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Registry',
          meta: { permission: { path: '/graduation-system-using-face-recognition/registry', action: 'view' } },
          component: GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONRegistry
        },
        {
