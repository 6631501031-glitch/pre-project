const th = {
    ...
    nav: {
        dashboard: "แดชบอร์ด",
        graduationsystemusingfacerecognitionRegistry: "ทะเบียน GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION",
        businessOperations: "งานปฏิบัติการ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION",
        banks: "ธนาคาร",
        template: "ต้นแบบ",
    ...
    graduationsystemusingfacerecognitionDashboard: {
        kicker: "งานปฏิบัติการ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION",
        title: "ศูนย์กลางจัดการ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION",
        ...
        actions: {
            openRegistry: "เปิดทะเบียน GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION"
        },
        scopeItems: {
            signIn: "Google sign-in สำหรับผู้ใช้ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION",
            delegatedPermission: "หน้าจอจัดการสิทธิ์ที่ส่งคำสั่งไป IAM",
            accountDirectory: "สารบบบัญชีที่ดึงสิทธิ์และข้อมูลจาก IAM",
            graduationsystemusingfacerecognitionRegistry: "ทะเบียน GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION การตรวจ การรายงาน และการต่ออายุ"
        },
        cards: {
            identity: {
                label: "แหล่งข้อมูลตัวตน",
                value: "IAM",
                hint: "GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION ไม่เก็บ identity master ซ้ำ"
            },
            apiFlow: {
                label: "รูปแบบ API",
                value: "Client Credentials",
                hint: "ใช้สำหรับการเชื่อม GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION ไป IAM แบบ delegated"
            },
            owner: {
    ...
    accounts: {
        directory: {
            ...
            messages: {
                ...
                removeConfirmMessage: "ลบ {account} ออกจาก GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION หรือไม่?",
                removeSuccess: "ลบบัญชีออกจาก GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION แล้ว",
                removeError: "ไม่สามารถลบบัญชีออกจาก GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION ได้",
                ...
                inviteTitle: "เชิญเข้า GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION",
                inviteSubtitle: "เชิญบัญชีและกำหนดสิทธิ์เข้า GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION",
                inviteSuccess: "เชิญบัญชีสำเร็จ",
                inviteError: "ไม่สามารถเชิญบัญชีเข้า GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION ได้"
            },
            invite: {
                email: "อีเมล",
                firstName: "ชื่อ",
                lastName: "นามสกุล",
                groups: "กลุ่ม GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION",
                groupPlaceholder: "เลือกกลุ่ม GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION อย่างน้อยหนึ่งกลุ่ม",
                groupRequired: "กรุณาเลือกกลุ่ม GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION อย่างน้อยหนึ่งกลุ่ม"
            }
        },
        permissions: {
    ...
    setting: {
        ...
        emailNotifications: {
            ...
            subtitle: "จัดการ workflow override ของ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION ที่ delegated ไปยัง IAM สำหรับอีเมลด้าน identity เช่น คำเชิญบัญชี รหัส 2FA และการแจ้งเปลี่ยนสถานะบัญชี",
        ...
        workflowActions: {
            ...
            subtitle: "ตั้งค่าพฤติกรรม action ของ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION email workflow ที่ delegated ไปยัง IAM เช่น ผู้รับ การเปิดใช้งาน และเงื่อนไขขณะรันระบบ",
        ...
        runtimeAccess: {
            ...
            hints: {
                trustProxy: "ใช้ X-Forwarded-* เมื่อ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION อยู่หลัง reverse proxy หรือ ingress",
        ...
        databaseBackup: {
            ...
            subtitle: "จัดการ backup ฐานข้อมูลของ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION ผ่าน CMS ทั้งการตั้ง auto backup, สั่ง manual, retention, download และลบไฟล์เก่า",
...
th.graduation = {
    ...
    fields: {
        ...
        programShort: "สาขา",
        ceremonyStatus: "สถานะการเข้ารับพระราชทานปริญญาบัตร",
        assistanceType: "ประเภทความช่วยเหลือกรณีพิเศษ",
        extraDetail: "รายละเอียดเพิ่มเติม",
        foodAllergy: "แพ้อาหารหรือไม่",
        foodAllergyNote: "รายละเอียดการแพ้อาหาร"
    },
    placeholders: {
        firstName: "เช่น กานต์",
        lastName: "เช่น ใจดี",
        firstNamePronunciation: "เช่น ลิ-ติ-รัต",
        lastNamePronunciation: "เช่น ช่วย-เพชร",
        extraDetail: "ระบุเหตุผลหรือรายละเอียดเพิ่มเติม",
        school: "เลือกสำนักวิชา",
        program: "เลือกสาขา/หลักสูตร",
        schoolFirst: "เลือกสำนักวิชาก่อน",
        ceremonyStatus: "เลือกสถานะการเข้ารับ",
        assistanceType: "เลือกประเภทความช่วยเหลือ"
    },
    options: {
        yes: "มี",
        no: "ไม่มี"
    ...
    assistanceType: {
        21: "ตั้งครรภ์ (ระบุอายุครรภ์ ณ เดือนกุมภาพันธ์ 2569)",
        22: "อุบัติเหตุ",
        23: "พิการ",
        24: "เหตุผลอื่น"
    },
    address: {
        home: "ที่อยู่ตามทะเบียนบ้าน",
    ...
    certificate: {
        ...
        shipping: {
            "registered-domestic": {
                label: "ไปรษณีย์ลงทะเบียนในประเทศ",
                description: "ตัวอย่างค่าบริการสำหรับจัดส่งในประเทศไทย"
            },
            "registered-international": {
                label: "ไปรษณีย์ลงทะเบียนต่างประเทศ",
                description: "ตัวอย่างค่าบริการสำหรับจัดส่งต่างประเทศ"
            },
            "ems-domestic": {
                label: "EMS ในประเทศ",
                description: "ตัวอย่างค่าบริการด่วนพิเศษในประเทศไทย"
            },
            "ems-international": {
                label: "EMS ต่างประเทศ",
                description: "ตัวอย่างค่าบริการด่วนพิเศษต่างประเทศ"
            }
        }
    },
    self: {
        ...
        summary: {
            title: "สรุปข้อมูล",
            name: "ชื่อ",
            pronunciation: "สะกดชื่อ",
            ceremonyStatus: "สถานะเข้ารับ"
        }
    },
    admin: {
        ...
        table: {
            ...
            schoolProgram: "สำนักวิชา / สาขา",
            ceremonyStatus: "สถานะเข้ารับ",
            assistanceType: "ประเภทช่วยเหลือ",
            contact: "ติดต่อ",
        ...
        details: {
            ...
            assistanceType: "ประเภทช่วยเหลือ",
            extraDetail: "รายละเอียดเพิ่มเติม",
            certificateMethod: "ช่องทางรับประกาศนียบัตร",
            shippingService: "บริการจัดส่ง",
            certificateAddress: "ที่อยู่จัดส่งประกาศนียบัตร",
            foodAllergy: "แพ้อาหาร",
            foodAllergyNote: "รายละเอียดแพ้อาหาร"
        },
        messages: {
            loadError: "โหลดข้อมูลลงทะเบียนไม่สำเร็จ",
            deleteConfirm: "ลบข้อมูลของ {name}?",
            thisRecord: "รายการนี้",
            deleteSuccess: "ลบข้อมูลลงทะเบียนแล้ว",
            deleteError: "ลบข้อมูลลงทะเบียนไม่สำเร็จ"
        }
    },
    messages: {
        requiredField: "\u0e01\u0e23\u0e38\u0e13\u0e32\u0e01\u0e23\u0e2d\u0e01\u0e02\u0e49\u0e2d\u0e21\u0e39\u0e25\u0e19\u0e35\u0e49",
        foodAllergyRequired: "กรุณาระบุรายละเอียดว่าแพ้อาหารอะไร ห้ามเว้นว่างหรือใส่ -",
        selectCertificateMethod: "กรุณาเลือกช่องทางการรับประกาศนียบัตร",
        selectShippingService: "กรุณาเลือกบริการจัดส่งประกาศนียบัตร",
        enterCertificateAddress: "กรุณากรอกที่อยู่สำหรับจัดส่งประกาศนียบัตร",
        saveSuccess: "บันทึกข้อมูลลง MongoDB แล้ว",
        saveDraftOnly: "บันทึกลง MongoDB ไม่สำเร็จ แต่เก็บแบบร่างไว้ในเครื่องแล้ว",
        clearConfirm: "ต้องการเคลียร์ข้อมูลทั้งหมดในฟอร์มนี้ใช่ไหม?",
        clearSuccess: "เคลียร์ข้อมูลทั้งหมดแล้ว"
    }
}
