...
export default {
  ...
  actions: {
    ...
    async removeGRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONAccess({ dispatch, state }, payload) {
      await Service.accounts('remove-graduationsystemusingfacerecognition-access', payload)
      await dispatch('explorer', {
        page: state.pagination.page,
        limit: state.pagination.limit,
        search: state.pagination.search
