const PROJECT_PERMISSION_TYPE_TITLE = process.env.VUE_APP_PROJECT_PERMISSION_TYPE_TITLE || 'GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION Administration'
const PROJECT_PERMISSION_ROOT_PATH = process.env.VUE_APP_PROJECT_PERMISSION_ROOT_PATH || '/graduation-system-using-face-recognition/security/permission'
const PROJECT_APP_ID = process.env.VUE_APP_PROJECT_APP_ID || 'graduationsystemusingfacerecognition'
...
export function normalizeGRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONData (data) {
