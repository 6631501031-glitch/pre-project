...
import { normalizeGRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONData } from './bootstrap-filter'
...
export async function fetchSecurityBootstrap () {
  ...
  return normalizeGRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITIONData({
