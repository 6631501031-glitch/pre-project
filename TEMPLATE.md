# GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION
...
The generated `.gitlab-ci.yml` builds backend/frontend images, pushes them to Harbor, and deploys `docker-compose.gitlab.yml` to `/opt/service/graduation-system-using-face-recognition`.
