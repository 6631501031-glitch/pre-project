# GRADUATION SYSTEM USING FACE RECOGNITION GRADUATION SYSTEM USING FACE RECOGNITION AI Documentation Index

This docs set controls AI-assisted delivery for `graduation-system-using-face-recognition`. Keep it aligned with source code, tests, and release evidence.
...
| `docs/prd/PRD-graduation-system-using-face-recognition.md` | Product requirement truth, or replace with the actual PRD path used by this project. | yes |
