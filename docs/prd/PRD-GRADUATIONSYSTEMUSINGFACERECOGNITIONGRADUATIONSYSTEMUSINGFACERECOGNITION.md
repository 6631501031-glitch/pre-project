# PRD: GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION

## Document Control

| Field | Value |
|---|---|
| Product | GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION |
| Project code | graduationsystemusingfacerecognition |
| Version | 0.1 |
...
| Public domain | `graduation-system-using-face-recognition.mfu.ac.th` |
...
GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION is agreement management application integrated with IAM for GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION registry workflows, account directory, security permissions, settings, and deployment through Docker.

Detected package names at generation time:

| Runtime | Package |
|---|---|
| Backend | `graduationsystemusingfacerecognition-api` |
| Frontend | `graduationsystemusingfacerecognition-frontend` |
...
- 9: app.use(path + '/graduationsystemusingfacerecognition', graduationsystemusingfacerecognitionRoutes);
...
| graduationsystemusingfacerecognition | `backend-node/server/Project/graduationsystemusingfacerecognition` |
...
| graduationsystemusingfacerecognition | `frontend-vue/src/projects/views/graduationsystemusingfacerecognition` |
...
### FR-GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION-001 Authentication And Session
...
### FR-GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION-002 Account Directory And Lifecycle
...
### FR-GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION-003 Project Business Workflows
...
### FR-GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION-004 Security And Permission Management
...
### FR-GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION-005 Settings And Operations
