# T1-T20 Change Document: GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION 2FA OTP Paste Support

## T1 Change Title

| Field | Value |
|---|---|
| Change ID | GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION-2FA-OTP-PASTE-20260605 |
| Module | GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION frontend 2FA dialog |
| Date | 2026-06-05 |
...
- Post-deploy Docker health passed for `graduationsystemusingfacerecognition-backend-1`, `graduationsystemusingfacerecognition-frontend-1`, and `graduationsystemusingfacerecognition-redis-1`.
- Server localhost smoke passed: web returned `200`; unauthenticated `/api/v1/auth/me` returned `401`.
- Public DNS smoke pending: `https://graduation-system-using-face-recognition.mfu.ac.th/` did not resolve from the test client.
...
- Release: rebuild and deploy GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION frontend.
