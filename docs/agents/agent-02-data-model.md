...
ควบคุม schema, data contract, migration, seed, index และ compatibility ของ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION ให้รองรับ feature ใหม่โดยไม่ทำลาย behavior เดิม.
...
- current models:
  ...
  - `backend-node/server/Project/graduationsystemusingfacerecognition/models/*.js`
...
- controllers/services that normalize payload:
  ...
  - `backend-node/server/Project/graduationsystemusingfacerecognition/service/graduationsystemusingfacerecognition_document.js`
...
## Current GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION Data Areas

| Domain | Main collections/models |
|---|---|
| Accounts | `accounts/models/account.model.js` |
| GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION documents | `graduationsystemusingfacerecognition/models/graduationsystemusingfacerecognition_document.model.js` |
...
```txt
ทำหน้าที่ Data Model Agent สำหรับ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION
FR: [FR-GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION-xxx]
...
Constraints:
- ยึด model เดิมของ GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION
