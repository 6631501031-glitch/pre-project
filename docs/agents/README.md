# GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION Agent Operating Model

อัปเดตจาก source repo `GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION` ณ วันที่ 2026-06-04

เอกสารชุดนี้คือ operating manual สำหรับใช้ agents พัฒนาและดูแล GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION. ทุก agent ต้องยึด `docs/AI-WORKFLOW.md`, source code ปัจจุบัน, route mount จริง, frontend route/API จริง และ permission model ที่มีอยู่ ไม่ใช่ prompt ทั่วไป.
...
| `docs/prd/PRD-GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION.md` | product requirement baseline |
...
|---|---|
| new GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION feature | Orchestrator, PO, Data Model, Backend, Frontend, Security, QA, Release |
...
- Update `docs/prd/PRD-GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION.md` when behavior, API, UI, data, permission, test, or release contract changes.
- Run scoped tests/verification before marking implementation done.

## GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION Source Map For Agents
...
| GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION document registry | `backend-node/server/Project/graduationsystemusingfacerecognition` | `src/projects/views/graduationsystemusingfacerecognition`, `Service.graduationsystemusingfacerecognitionDocuments` |
...
- `orchestrator-example.md`: end-to-end example using the GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION document registry flow
- `sprint-task-template.md`: reusable task/sprint/handoff template

## Quick Prompt

```txt
ทำงานตาม GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION agent workflow
Requirement: [describe request]
Source docs:
- docs/AI-WORKFLOW.md
- docs/prd/PRD-GRADUATIONSYSTEMUSINGFACERECOGNITIONGRADUATIONSYSTEMUSINGFACERECOGNITION.md
